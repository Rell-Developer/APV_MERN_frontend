...
const CambiarPassword = () => {
  ...
  const handleSubmit =  async (e) => {
    ...
    let resultado = await guardarPassword(password);
    if(resultado.error != undefined){
      if(resultado.error){
        return setAlerta({msg: resultado.msg, error: true})
      }
    }else{

      setAlerta({msg: resultado.msg})
    }
  }
  ...
  return (
    <>
        ...
        <div className="flex justify-center">
          <div className="w-full md:w-1/2 bd-white shadow rounded-lg p-5">
